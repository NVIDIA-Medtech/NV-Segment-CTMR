...
def main():
    ...
    parser.add_argument("-m", "--mask", dest="mask_path", default=None, help="Path to brain mask of the moving image (NIfTI)")
    parser.add_argument(
        "-s",
        "--save-preprocess",
        dest="meta_path",
    ...
    img_ants = ants.apply_transforms(
        fixed=tmp_ants,
        moving=img_ants,
        transformlist=regMovTmp["fwdtransforms"],
    )
